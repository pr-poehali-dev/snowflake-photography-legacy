...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center p-8 bg-gradient-to-br from-slate-100 via-blue-50 to-slate-200">
      <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23e2e8f0" fill-opacity="0.3"%3E%3Cpath d="M30 30l15-15v30l-15-15zm-15 15h30v-30h-30v30z"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-20"></div>
      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
        <div className="text-center lg:text-left">
          ...
          <p className="text-xl text-slate-600 mb-8 leading-relaxed">
            Человек, который в 1870-х годах в Рыбинске совершил революцию в макрофотографии, 
            опередив весь мир в искусстве запечатления красоты снежинок
          </p>
          ...
          <div className="relative group">
            ...
            <Card className="relative p-8 bg-white/90 backdrop-blur rounded-2xl shadow-2xl">
              ...
              <div className="mt-6 text-center">
                <h3 className="text-xl font-semibold text-slate-800">Андрей Андреевич Сигсон</h3>
